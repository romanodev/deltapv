...
def contact_phin(cell: PVCell, neq0: f64, neqL: f64, phi_n: Array, phi: Array) -> f64:
...
def contact_phin_deriv(cell: PVCell, phi_n: Array, phi: Array) -> Tuple[f64, f64, f64, f64]:
...
def contact_phip(cell: PVCell, peq0: f64, peqL: f64, phi_p: Array, phi: Array) -> f64:
...
def contact_phip_deriv(cell: PVCell, phi_p: Array, phi: Array) -> Tuple[f64, f64, f64, f64]:
