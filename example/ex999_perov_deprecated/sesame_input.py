...
PEROV_REGION = lambda x: np.logical_and(ETM_THICKNESS < x, x <= ETM_THICKNESS +
                                        PEROV_THICKNESS)
HTM_REGION = lambda x: np.logical_and(ETM_THICKNESS + PEROV_THICKNESS < x, x <=
                                      CELL_THICKNESS)
...
sys.contact_type(Lcontact_type, Rcontact_type, Lcontact_workFcn,
                 Rcontact_workFcn)
