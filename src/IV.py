...
#    print( gradtest[0] )
#    print( gradphieq['eps'] )
    print( gradtest[0][:,0] , gradtest[0][:,-1] )
    print( dphi_ini_dChi0 , dphi_ini_dChiL )
#    print( gradphieq['Chi'] )
    print( gradtest[1][:,0] , gradtest[1][:,-1] )
    print( dphi_ini_dEg0 , dphi_ini_dEgL )
#    print( gradphieq['Eg'] )
    print( gradtest[2][:,0] , gradtest[2][:,-1] )
    print( dphi_ini_dNc0 , dphi_ini_dNcL )
#    print( gradphieq['Nc'] )
    print( gradtest[3][:,0] , gradtest[3][:,-1] )
    print( dphi_ini_dNv0 , dphi_ini_dNvL )
#    print( gradphieq['Nv'] )
    print( gradtest[4][:,0] , gradtest[4][:,-1] )
    print( dphi_ini_dNdop0 , dphi_ini_dNdopL )
