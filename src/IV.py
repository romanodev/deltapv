...
def grad_IV( dgrid , Vincrement , eps , Chi , Eg , Nc , Nv , Ndop , mn , mp , Et , tn , tp , Br , Cn , Cp , Snl , Spl , Snr , Spr , G_used ):
    ...
    while cond and ( iter < max_iter ):
        ...
        jac_phis['Chi'] = gradsol[6] + np.dot( gradsol[0] , np.matrix( dneq0_dChi ).T ) + np.dot( gradsol[1] , np.matrix( dneqL_dChi ).T ) + np.dot( gradsol[2] , np.matrix( dpeq0_dChi ).T ) + np.dot( gradsol[3] , np.matrix( dpeqL_dChi ).T ) + np.dot( gradsol[4] , jac_phis['Chi'] )
        jac_phis['Eg'] = gradsol[7] + np.dot( gradsol[0] , np.matrix( dneq0_dEg ).T ) + np.dot( gradsol[1] , np.matrix( dneqL_dEg ).T ) + np.dot( gradsol[2] , np.matrix( dpeq0_dEg ).T ) + np.dot( gradsol[3] , np.matrix( dpeqL_dEg ).T )+ np.dot( gradsol[4] , jac_phis['Eg'] )
        jac_phis['Nc'] = gradsol[8] + np.dot( gradsol[0] , np.matrix( dneq0_dNc ).T ) + np.dot( gradsol[1] , np.matrix( dneqL_dNc ).T ) + np.dot( gradsol[2] , np.matrix( dpeq0_dNc ).T ) + np.dot( gradsol[3] , np.matrix( dpeqL_dNc ).T )+ np.dot( gradsol[4] , jac_phis['Nc'] )
        jac_phis['Nv'] = gradsol[9] + np.dot( gradsol[0] , np.matrix( dneq0_dNv ).T ) + np.dot( gradsol[1] , np.matrix( dneqL_dNv ).T ) + np.dot( gradsol[2] , np.matrix( dpeq0_dNv ).T ) + np.dot( gradsol[3] , np.matrix( dpeqL_dNv ).T )+ np.dot( gradsol[4] , jac_phis['Nv'] )
        jac_phis['Ndop'] = gradsol[10] + np.dot( gradsol[0] , np.matrix( dneq0_dNdop ).T ) + np.dot( gradsol[1] , np.matrix( dneqL_dNdop ).T ) + np.dot( gradsol[2] , np.matrix( dpeq0_dNdop ).T ) + np.dot( gradsol[3] , np.matrix( dpeqL_dNdop ).T )+ np.dot( gradsol[4] , jac_phis['Ndop'] )
