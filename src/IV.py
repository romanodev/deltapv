...
def grad_IV( dgrid , Vincrement , eps , Chi , Eg , Nc , Nv , Ndop , mn , mp , Et , tn , tp , Br , Cn , Cp , Snl , Spl , Snr , Spr , G_used ):
    ...
    while cond and ( iter < max_iter ):
        ...
        print( np.allclose( gradtest[0] , gradsol['neq_0'] ) )
        print( np.allclose( gradtest[1] , gradsol['neq_L'] ) )
        print( np.allclose( gradtest[2] , gradsol['peq_0'] ) )
        print( np.allclose( gradtest[3] , gradsol['peq_L'] ) )
